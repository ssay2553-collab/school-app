module.exports = ({ config }) => {
  ...
  const schools = {
    ...
    stone: {
      ...
      scheme: "stone",
      logo: "./assets/icon-spring.png",
      hotline: "0244579244",
      fullName: "Spring Gate International School",
      motto: "Deligence, Descipline and Quality Education",
      address: "Obom Road, Ghana Flag Junction",
      email: "",
      primaryColor: "#482fd4ff",
      secondaryColor: "#6361e9ff",
      surfaceColor: "#f7f6d1ff",
      brandPrimary: "#0e2a86ff",
      brandSecondary: "#fcf8f9ff",
