module.exports = ({ config }) => {
  ...
  const schools = {
    ...
    morgis: {
      ...
      scheme: "morgis",
      logo: "./assets/icon-kings.png",
      hotline: "0548797998",
      fullName: "Academy of Kings Kids",
      motto: "Be the Light",
      address: "Galilea, Kasoa-Ghana",
      email: "",
      primaryColor: "#04fc2eff",
      secondaryColor: "#0a9c3bff",
      surfaceColor: "#FDF7FF",
      brandPrimary: "#35af54ff",
      brandSecondary: "#11e669ff",
    ...
    IBS: {
      ...
      scheme: "IBS",
      logo: "./assets/icon-advent.png",
      hotline: "",
      fullName: "Advent Reformed Institutions",
    ...
    perfect: {
      ...
      scheme: "perfect",
      logo: "./assets/tapm-icon.jpg",
      hotline: "0553641188",
      fullName: "The Angel's Pride Montessori",
      motto: "Success is certain",
      address: "Lakeside Estates, Community 1",
      email: "",
      primaryColor: "#6691C7",
      secondaryColor: "#F7B044",
      surfaceColor: "#FFFFFF",
      brandPrimary: "#F7B044",
      brandSecondary: "#6691C7",
    ...
    jewel: {
      ...
      fullName: "Jewel Stars Academy",
      motto: "The Fear Of The Lord",
      address: "Kasoa New Market, Kasoa, Ghana",
      email: "",
    ...
    lilies: {
      ...
      scheme: "lilies",
      logo: "./assets/icon-phec.png",
      hotline: "+233 50 111 7290 / 0553041789",
      fullName: "The Potters House Education Centre",
      motto: "Passion For Excellence",
      address: "Greater Accra Region, Weija",
      email: "",
      primaryColor: "#F5E9D3",
      secondaryColor: "#002c66",
      surfaceColor: "rgb(255, 254, 254)",
      brandPrimary: "#003366",
      brandSecondary: "#F5E9D3",
      easProjectId: "b19bf821-a509-49dd-909e-ca094b5a5718",
      firebase: {
    ...
    kent: {
      ...
      scheme: "kent",
      logo: "./assets/icon-sage.png",
      hotline: "0540126050",
      fullName: "World Sage School",
      motto: "Knowledge, Integrity and Excellence",
      address: "Galilea, Official Town, Kasoa",
      email: "",
      primaryColor: "#F7D64A",
      secondaryColor: "#4A9ACD",
      surfaceColor: "#A9D8F2",
      brandPrimary: "#F9C33A",
      brandSecondary: "#6EC1E4",
