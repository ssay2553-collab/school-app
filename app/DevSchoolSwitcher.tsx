...
const SCHOOLS = [
  ...
  { id: "beano", name: "Beano App", color: "#6503a1" },
  { id: "morgis", name: "Kings Kids", color: "#35af54" },
  { id: "IBS", name: "IBS App", color: "#1C6E3C" },
  { id: "perfect", name: "PEI End", color: "#C1272D" },
  { id: "creation", name: "Creation Star", color: "#585858" },
  { id: "clis", name: "CLIS App", color: "#3cca48" },
  { id: "jewel", name: "Jewel App", color: "#f75ac7" },
  { id: "stone", name: "Spring Gate", color: "#0e2a86" },
  { id: "kent", name: "World Sage", color: "#4A9ACD" },
  { id: "bishops", name: "Bishop App", color: "#1E4D8C" },
  { id: "bms", name: "BMS App", color: "#1A237E" },
  { id: "model", name: "Model Power", color: "#8a1010" },
  { id: "brain", name: "Bright Brain", color: "#7B2CBF" },
  { id: "cascom", name: "CASCOM App", color: "#0D47A1" },
  { id: "abijah", name: "Abijah Adesua", color: "#0d09f5" },
];
