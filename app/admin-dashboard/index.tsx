  ...
  return (
    <View style={[styles.container, { backgroundColor: surface }]}>
      ...
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => fetchStats(true)} tintColor={primary} />}
        ...
        <LinearGradient colors={[primary, secondary]} style={styles.header}>
          <SafeAreaView edges={['top']}>
            <View style={styles.headerTop}>
                ...
                <TouchableOpacity onPress={() => router.push("/admin-dashboard/settings")} style={styles.settingsBtn}>
            ...
            <View style={styles.statsGrid}>
                ...
                <View>
                    ...
                    <Text style={styles.statValue}>{stats.loading ? "--" : stats.totalStudents}</Text>
                </View>
                </View>
                <View style={[styles.statCard, { backgroundColor: "rgba(255,255,255,0.15)" }]}>
                ...
                <View>
                    ...
                    <Text style={styles.statValue}>{stats.loading ? "--" : stats.totalStaff}</Text>
                </View>
                </View>
            </View>
          </SafeAreaView>
        ...
        <View style={styles.mainContent}>
          {sections.map((section, sIndex) => (
            <View key={section.title} style={styles.section}>
              <Text style={section.title === "Organization" ? styles.sectionTitleFirst : styles.sectionTitle}>{section.title}</Text>
...
const styles = StyleSheet.create({
  ...
  headerTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 35, paddingTop: Platform.OS === 'web' ? 20 : 0 },
  ...
  sectionTitleFirst: { fontSize: 14, fontWeight: "900", color: "#1f2937", marginBottom: 15, letterSpacing: 1, opacity: 0.6 },
  sectionTitle: { fontSize: 14, fontWeight: "900", color: "#1f2937", marginBottom: 15, letterSpacing: 1, opacity: 0.6, marginTop: 10 },
