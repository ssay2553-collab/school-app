...
export default function ViewAcademicRecordDetails() {
  ...
  const generatePDF = async () => {
    if (subjectsData.length === 0)
      return Alert.alert("No Data", "No records found.");
      ...
      >
        ...
        >
          ...
          <View style={styles.letterhead}>
            ...
            <View style={styles.schoolDetails}>
              ...
              <Text style={styles.schoolAddress}>
                {SCHOOL_CONFIG.address || "Quality Education for All"}
              </Text>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>{classIdState}</Text>
            </View>
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>YEAR:</Text>
              <Text style={styles.infoValue}>{academicYearState}</Text>
            </View>
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>TERM:</Text>
              <Text style={styles.infoValue}>{termState}</Text>
            </View>
          </View>
          ...
          <View style={styles.summarySection}>
            ...
            {isFullReport && (
              <View style={styles.summaryItem}>
                <Text style={styles.summaryLabel}>PROMOTED TO:</Text>
                <Text style={styles.summaryVal}>{promotedTo || "N/A"}</Text>
              </View>
            )}
          </View>
            ...
            <View style={styles.remarksSection}>
              ...
              <View style={styles.ratingRow}>
                <Text style={styles.ratingText}>
                  Conduct: <Text style={styles.boldText}>{conduct}</Text>
                </Text>
                <Text style={styles.ratingText}>
                  Attitude: <Text style={styles.boldText}>{attitude}</Text>
                </Text>
                <Text style={styles.ratingText}>
                  Interest: <Text style={styles.boldText}>{interest}</Text>
                </Text>
              </View>

              <Text style={[styles.sectionHeading, { marginTop: 15 }]}>
                TEACHER'S REMARKS
              </Text>
              <View style={styles.remarkBox}>
                <Text style={styles.remarkText}>
                  {teacherRemarks ||
                    "A satisfactory performance. Maintain the effort."}
                </Text>
              </View>
              ...
              <View style={styles.remarkBox}>
                <Text style={styles.remarkText}>
                  {adminRemarks ||
                    "Performance is commendable. Aim for higher marks next term."}
                </Text>
              </View>

              <View style={styles.nextTermRow}>
                <Text style={styles.nextTermLabel}>NEXT TERM BEGINS:</Text>
                <Text style={styles.nextTermVal}>
        ...
        <View style={styles.noticeBox}>
          ...
          <Text style={styles.noticeText}>
            This is a read-only document. Adjustments must be done in the
            Academic Ledger.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  nextTermVal: {
    fontSize: 11,
    fontWeight: "800",
    color: SCHOOL_CONFIG.primaryColor || (COLORS as any)?.primary || "#2e86de",
  },
  footer: {
    flexDirection: "row",
    justifyContent: "space-between",
