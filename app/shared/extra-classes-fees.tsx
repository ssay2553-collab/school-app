        ...
        <View style={styles.recordContent}>
          ...
          <View style={styles.recordDetails}>
            <View style={styles.recordFeeItem}>
              <SVGIcon name="book" size={14} color={VIBE.purple} />
              <Text style={styles.recordFeeText}>₵{item.extraClassesFee}</Text>
            </View>
          </View>
              ...
              {isSuperAdmin && (
                <View style={{ paddingHorizontal: 16, marginBottom: 16 }}>
                  <TouchableOpacity
                    style={[
                      styles.disburseBtn,
                      (saving || stats.totalExtraClasses <= 0) && {
                        opacity: 0.6,
                      },
                    ]}
                    onPress={handleDisburseToStaff}
                    disabled={saving || stats.totalExtraClasses <= 0}
                  >
                    <SVGIcon name="wallet" size={20} color="#fff" />
                    <Text style={styles.disburseBtnText}>
                      Disburse ₵{stats.totalExtraClasses.toFixed(2)} to Staff
                    </Text>
                  </TouchableOpacity>
                </View>
              )}
                ...
                {isSuperAdmin && selectedClassId !== "all" && (
                  <View style={styles.inputGroup}>
                    ...
                    <View style={styles.amountInputContainer}>
                      <SVGIcon name="cash" size={20} color={VIBE.purple} />
                      <TextInput
                        style={styles.amountInput}
                        placeholder="0.00"
                        value={extraClassesAmount}
                        onChangeText={setExtraClassesAmount}
                ...
                <View style={styles.reportStats}>
                  <View style={styles.reportRow}>
                    <Text style={styles.reportLabel}>
                      Total Extra Classes Collected
                    </Text>
                    <Text style={[styles.reportValue, { color: VIBE.purple }]}>
                      ₵{stats.totalExtraClasses.toFixed(2)}
                    </Text>
                  </View>
                  <View style={styles.reportRow}>
...
const styles = StyleSheet.create({
  ...
  disburseBtnText: { color: "#fff", fontSize: 15, fontWeight: "800" },
