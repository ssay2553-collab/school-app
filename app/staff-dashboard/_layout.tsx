...
import { TouchableOpacity, View, Image, Text, StyleSheet, Alert, Platform, ActivityIndicator } from "react-native";
...
export default function StaffDashboardLayout() {
  ...
  useEffect(() => {
    if (!loading && !appUser) {
      router.replace("/");
    } else if (!loading && appUser && appUser.role !== "staff" && appUser.role !== "admin") {
       // Staff dashboard is specifically for 'staff' role. Admins can view for testing.
       router.replace("/");
    }
  }, [appUser, loading]);
      ...
      <View style={styles.header}>
        <View style={styles.schoolInfo}>
          ...
          <View>
            ...
            <Text style={[styles.portalTag, { color: primary }]}>Staff Portal</Text>
          </View>
        </View>
