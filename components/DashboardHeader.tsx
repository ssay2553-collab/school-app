        ...
        <View style={styles.headerRow}>
          <View style={styles.userInfo}>
            ...
            >
              {appUser?.profile?.profileImage ? (
                ...
                <View style={styles.profilePlaceholder}>
                  ...
                  >
                    {appUser?.profile?.firstName?.[0] || roleTag.charAt(0)}
                  </Text>
                </View>
              )}
            </TouchableOpacity>
            <View style={{ marginLeft: isSmallScreen ? 10 : 15, flex: 1 }}>
              ...
              >
                {appUser?.profile?.firstName || roleTag}
              </Text>

              <View style={styles.roleBadge}>
                <SVGIcon name="checkmark-seal" size={12} color="#fff" />
                <Text style={styles.roleBadgeText}>
                  {appUser?.adminRole || roleTag.toUpperCase()}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.headerActions}>
            ...
            {showTeacherButton && (
              ...
              >
                ...
                <Text style={styles.actionBtnText}>TEACHER</Text>
              </TouchableOpacity>
            )}
...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: 32, fontWeight: "900", color: "#fff", marginTop: 2 },
  roleBadge: {
    flexDirection: "row",
