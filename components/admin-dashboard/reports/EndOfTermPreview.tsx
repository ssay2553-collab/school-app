...
export const EndOfTermPreview: React.FC<Props> = ({
  primary,
  studentName,
  className,
  classIdState,
  ...
  return (
    <View>
      <View style={styles.reportTitleContainer}>
        <Text style={styles.reportTitleText}>TERMINAL PROGRESS REPORT</Text>
      </View>
      ...
      <View style={styles.paperInfoGrid}>
        {[
          ...
          { label: "TERM / PERIOD", value: termState },
      ...
      <View style={styles.paperSummaryRow}>
        <View style={styles.summaryContainer}>
          ...
          <View style={styles.summaryItem}>
            ...
            <Text style={[styles.summaryValue, { color: "#e11d48" }]}>{AGGREGATE}</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  behaviorGrid: { flexDirection: "row", padding: 8, gap: 15 },
  behaviorItem: { flex: 1 },
  behaviorLabel: { fontSize: 7, fontWeight: "900", color: "#94A3B8", marginBottom: 2 },
  behaviorValue: { fontSize: 10, fontWeight: "700", color: "#1E293B" },
  statusBox: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#F0FDFA", borderWidth: 1, borderColor: "#CCFBF1", padding: 10, borderRadius: 4, marginTop: 5 },
  statusItem: { flex: 1 },
  statusLabel: { fontSize: 7, fontWeight: "900", color: "#0D9488", marginBottom: 2 },
  statusValue: { fontSize: 10, fontWeight: "900", color: "#0F766E" },
