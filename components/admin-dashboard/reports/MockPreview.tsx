...
export const MockPreview: React.FC<Props> = ({
  primary,
  studentName,
  className,
  classIdState,
  ...
  return (
    <View>
      <View style={styles.reportTitleContainer}>
        <Text style={styles.reportTitleText}>{mockTitle} EXAMINATION REPORT</Text>
      </View>
      ...
      <View style={styles.paperInfoGrid}>
        {[
          ...
          { label: "ASSESSMENT", value: mockTitle },
      ...
      <View style={styles.paperTable}>
        <View style={[styles.paperTableHeader, { backgroundColor: primary }]}>
          ...
          <Text style={styles.paperHeaderCell}>GRADE</Text>
