...
import { VIBE } from "./BusFeeConstants";
import { StudentRecord, DailyRecord } from "../../hooks/shared/useBusFeeLogic";
      ...
      <View style={styles.studentActions}>
        ...
        <TouchableOpacity
          style={[
            ...
            existingRecord && (existingRecord.busFee || 0) > 0 && !isPaid && styles.actionBtnActiveUnpaid,
            (!canEdit || isAbsent) && { opacity: 0.5 },
          ]}
          onPress={async () => {
            if (!canEdit) return;
        ...
        >
          <SVGIcon
            name="close"
            size={18}
            color={existingRecord && (existingRecord.busFee || 0) > 0 && !isPaid ? "#fff" : VIBE.danger}
          />
          <Text
            style={[
