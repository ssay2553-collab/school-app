...
const AUDIENCE_THEMES = {
  all: { color: "#6366F1", label: "PUBLIC", icon: "globe" },
  teacher: { color: "#10B981", label: "STAFF", icon: "people" },
  student: { color: "#F59E0B", label: "STUDENTS", icon: "school" },
  parent: { color: "#EC4899", label: "PARENTS", icon: "home" },
};
      ...
      <View style={[styles.container, styles.birthdayContainer, { borderColor: brandPrimary + '40' }]}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.expiryText}>Today Only ✨</Text>
          </View>
        </View>
      </View>
    );
    ...
    <View style={[styles.container, isExpired && styles.expiredContainer]}>
      ...
      <View style={[styles.headerStrip, { backgroundColor: theme.color }]}>
        ...
        <Text style={styles.dateText}>
          {createdAtDate ? createdAtDate.toLocaleDateString(undefined, { day: 'numeric', month: 'short' }) : ""}
        </Text>
      </View>
